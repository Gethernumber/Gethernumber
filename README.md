...
Заряженный Junior QA, недавно завершивший обучение и готовый к боевым задачам. Обожаю докапываться до сути багов и следить за тем, чтобы продукт становился лучше с каждым релизом. Владею техниками тест-дизайна, умею работать с DevTools и тестировать API через Postman. Моя цель — обеспечивать высокое качество продукта через внимательность к деталям и структурированный подход к проверкам.
